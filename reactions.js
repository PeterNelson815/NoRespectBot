...
const getReactionEmojiList = (message) => {
  ...
  let reactionEmojis = []
  if (
    messageLowerCase.includes('cumbus') ||
    messageLowerCase.includes('shortz') ||
    messageLowerCase.includes('crossword')
  )
    reactionEmojis.push('nrcumbus')
  if (
    messageLowerCase.match(/\b(ben)\b/) ||
    messageLowerCase.includes('good boy')
  )
    reactionEmojis.push('nrben')
  if (
    messageLowerCase.match(/\b(gretch)\b/) ||
    messageLowerCase.match(/\b(gretchen)\b/) ||
    messageLowerCase.includes('good girl')
  )
  ...
  if (messageLowerCase.includes('are you serious'))
    reactionEmojis.push('nridontbelieveyou')
  if (messageLowerCase === 'what' || messageLowerCase === 'what?')
    reactionEmojis.push('nrwhat')
